"""
Supervised_FineTuning/run_sft_qa.py
-------------------------------------
Fine-tunes the model on legal document Q&A.
The model learns to answer questions about legal documents using its knowledge.
...
def main():
    parser = argparse.ArgumentParser(description="SFT: Legal Q&A")
    ...
    dataset = load_dataset(
        "json",
        data_files={"train": data_cfg["qa_train"], "validation": data_cfg["qa_val"]},
    ...
    output_dir = train_cfg["qa_output_dir"]
    ...
    logger.info("Starting SFT — Q&A Task...")
    trainer.train()
    trainer.save_model(output_dir)
    tokenizer.save_pretrained(output_dir)
    logger.info(f"SFT Q&A complete! Model saved to {output_dir}")
